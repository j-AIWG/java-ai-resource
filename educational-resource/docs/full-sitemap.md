...
classDef custom4 fill:#ffcccc,stroke:green,stroke-width:4px,stroke-dasharray:0;
...
classDef custom7 fill:#ffd699,stroke:green,stroke-width:4px,stroke-dasharray:0;
...
classDef custom71 fill:#d5b3ff,stroke:yellow,stroke-width:4px,stroke-dasharray:0;
class n_50_ethics custom71;
classDef custom72 fill:#ffcccc,stroke:green,stroke-width:4px,stroke-dasharray:0;
class n_50_ethics_10_ethical_ai custom72;
classDef custom73 fill:#ffcccc,stroke:yellow,stroke-width:4px,stroke-dasharray:0;
class n_50_ethics_20_legislation custom73;
classDef custom74 fill:#ffcccc,stroke:yellow,stroke-width:4px,stroke-dasharray:0;
...
classDef custom94 fill:#ffcccc,stroke:yellow,stroke-width:4px,stroke-dasharray:0;
class n_70_learning_paths_20_finetune_your_first_model custom94;
classDef custom95 fill:#ffcccc,stroke:green,stroke-width:4px,stroke-dasharray:0;
class n_70_learning_paths_30_new_to_java custom95;
classDef custom96 fill:#ffcccc,stroke:green,stroke-width:4px,stroke-dasharray:0;
class n_70_learning_paths_40_new_to_ai custom96;
classDef custom97 fill:#ffcccc,stroke:green,stroke-width:4px,stroke-dasharray:0;
class n_70_learning_paths_50_new_to_ml custom97;
classDef custom98 fill:#ffcccc,stroke:yellow,stroke-width:4px,stroke-dasharray:0;
...
classDef custom101 fill:#ffcccc,stroke:yellow,stroke-width:4px,stroke-dasharray:0;
class n_70_learning_paths_90_spring_ai_tutorial custom101;
linkStyle default interpolate basis
```

<small><strong>Legend:</strong><br />**🚧** status:stub | **👀** status:review-needed | **🔗** external-link:is_not_empty | **☕️** programming-language:java | **🐍** programming-language:python | **🐱** programming-language:kotlin<br />**border:🟢** level:beginner | **border:🟡** level:intermediate | **border:🟠** level:advanced | **border:🔴** level:expert</small>